...
CSV files are without a doubt the most commonly used format for holding data used during back testing. However, since there is no standard format, they differ a lot.
