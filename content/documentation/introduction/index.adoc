...
Welcome to the roboquant™ documentation. Just like the roboquant software, the documentation is also open source. So if you find mistakes or want to contribute, head over to the https://github.com/neurallayer/roboquant.org[GitHub documentation repository] where you can find the source.
