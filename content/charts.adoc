...
When dealing with large amount of data, visualizations can help to easier understand what is going on. _Roboquant_ comes with several types of charts included, that can help to understand how an algo-trading strategy is behaving.
