...
* [x] Optimized and fine-tuned back-test engine so the engine itself will not become a bottleneck
...
* [x] Many charts out of the box that provide insights into the feeds and the results of a run
