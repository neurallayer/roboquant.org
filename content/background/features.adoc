...
.Performance Test
****
To give an idea what performance can be achieved on moderate hardware (Apple MacBook Pro, JDK 17): running a complete back test containing more than 1 million price-bars using an EMA-Crossover strategy takes *180 milliseconds*.
