...
TIP: If you plan to make regualr changes and updates to the source code, checkout the https://github.com/apache/maven-mvnd[Maven Daemon] project that provides faster builds. Additionally, you can set the Kotlin incremental compiler property to true (in the main `pom.xml`).
