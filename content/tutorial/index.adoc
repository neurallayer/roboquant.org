...
.Contribution
****
The documentation is also open source, just like the software. So if you find mistakes or want to contribute, head over to the https://github.com/neurallayer/roboquant.org[GitHub documentation repository] where you can find the content. The documentation is written using the https://docs.asciidoctor.org/asciidoctor/latest/#relationship-to-asciidoc[AsciiDoc] format, so it's easy to modify with any editor.
****
