...
[#_custom_charts]
=== Custom Charts
Developing your own chart is not difficult. Roboquant uses the excellent https://github.com/ECharts-Java/ECharts-Java[ECharts-Java] library that makes it easy to create almost any chart from within your Java or Kotlin code.
