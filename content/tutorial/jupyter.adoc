...
== Usage
Since developing an automated trading strategy requires a lot of experimentations and testing, an interactive development environment like Jupyter Notebooks is ideal. Especially in the beginning phase, it can help to progress a lot quicker.
