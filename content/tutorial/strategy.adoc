...
It is up to the xref:policy.adoc[policy] how/if to use these attributes when generating the orders. But for example the probability could be used to determine the sizing of the order, a high probability means a larger size.
