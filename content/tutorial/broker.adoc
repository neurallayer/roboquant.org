...
In _roboquant, it is the broker that receives new orders and processes them. The outcome of this processing is an updated `Account` object. This object is the same for all broker implementations. This allows for a seamless transition between 4 the stages of developing a strategy.
