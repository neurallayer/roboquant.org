...
Since the properties of the account object are mostly plain Kotlin collections, you can use standard Kotlin access patterns. Additionally there are several extensions defined that might come in convenient when dealing with an account object.
...
.Equity
****
Equity is a key metric to monitor if you want to see how your account is performing during a run. The following two equations hold true when  when running a back test:
