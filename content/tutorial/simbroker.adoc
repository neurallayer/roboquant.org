...
.Equity
****
Equity is key attribute to monitor if you want to see how your account is performing. The following two equations hold true when using SimBroker when running a back test:
