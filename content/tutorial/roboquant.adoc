...
== Run
After you have created an instance of the `Roboquant` class and have a xref:../feed/index.adoc[data feed], you can start the run.

NOTE: The same `run` method is used for all the different stages, from back testing to live trading. See also xref:../introduction/four_stages.adoc[the 4 stages] for more details about these stages.
