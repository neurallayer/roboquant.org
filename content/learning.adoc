...
== Documentation
A good place to start learning how to use roboquant, is by reading the main link:/documentation/index.html[documentation]. It provides an overview of the key concepts and how to apply them when you develop your own strategies. There are many code snippets included that can be cut & pasted to have head start.
